...
void main() {
  ...
  test(
    'decisão de análises vira anotação rastreável e pode usar a Agenda existente',
    () {
      final center = read(
      ...
      expect(center, contains('bool savingDecisionNote = false;'));
      expect(center, contains("'Salvando em Anotações...'"));
