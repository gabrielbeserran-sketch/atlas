...
| Financeiro: diagnóstico seguro do provedor OCR | Em validação | 90% | O servidor traduz erros de chave, limite e modelo sem registrar foto, resposta bruta ou segredo. Sintaxe Python e contrato aprovados; falta publicar e repetir a leitura real. |
