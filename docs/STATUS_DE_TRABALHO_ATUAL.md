...
- Próximo marco: validar o desbloqueio offline pelo usuário, conferir GMD/cobertura com dados reais e consolidar a leitura operacional de Corte na próxima entrega.
