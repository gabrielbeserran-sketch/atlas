...
- Etapa atual: homologar o histórico em PostgreSQL isolado e confirmar a publicação da migração 0056 no Render; depois validar pesagem offline→online e PIN com dados reais. A revisão de conflitos já foi concluída. A fila de fotos fiscais não será refeita.
