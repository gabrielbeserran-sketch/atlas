      ...
      body: loading
          ...
          : ListView(
              ...
              children: [
                Wrap(
                  ...
                  children: [
                    _MetricCard(
                      ...
                      value: '${dashboard['data_quality_average'] ?? 0}%',
                    ),
                    _MetricCard(
                      title: 'Conformidade',
                    ...
                    _MetricCard(
                      ...
                      value: '${dashboard['healthy_services'] ?? 0}',
                    ),
                    _MetricCard(
                      title: 'Serviços indisponíveis',
                      value: '${dashboard['services_down'] ?? 0}',
                    ),
                    _MetricCard(
                ...
                if (assets.isEmpty)
                  const Card(
                    child: ListTile(title: Text('Nenhum ativo catalogado.')),
                  )
                else
                  ...assets
                      .take(8)
                      .map(
                        (item) => Card(
                          child: ListTile(
                            ...
                            trailing: Text('${item['quality_score'] ?? 0}%'),
                          ),
                        ),
                      ),
                const SizedBox(height: 24),
                ...
                if (incidents.isEmpty)
                  const Card(
                    child: ListTile(title: Text('Nenhum incidente aberto.')),
                  )
                else
                  ...incidents
                      .take(8)
