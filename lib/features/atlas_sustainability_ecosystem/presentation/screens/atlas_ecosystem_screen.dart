...
import 'package:projeto_atlas/features/atlas_sustainability_ecosystem/data/services/atlas_ecosystem_storage_service.dart';
...
class AtlasEcosystemScreen extends StatefulWidget {
  const AtlasEcosystemScreen({
...
class _AtlasEcosystemScreenState extends State<AtlasEcosystemScreen> {
  ...
  late AtlasEcosystemModule selectedModule;
  List<AtlasEcosystemRecord> records = [];
  bool loading = true;
  ...
  Future<void> load() async {
    ...
    loaded.sort(
      (first, second) => parseAtlasEcosystemDate(
        second.date,
      ).compareTo(parseAtlasEcosystemDate(first.date)),
    );
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          EnterpriseMetricCard(
                            title: 'Concluídos/ativos',
                            value: '${analytics.completedCount}',
                            subtitle: 'Processos ou dispositivos válidos',
...
class _EcosystemRecordFormState extends State<_EcosystemRecordForm> {
  ...
  Future<void> chooseDate() async {
    final parsed = parseAtlasEcosystemDate(date.text);
    ...
    setState(() {
      date.text = formatAtlasEcosystemDate(selected);
    });
  }
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Unidade',
                    hintText: 'Ex.: kg CO₂e, m³, %, leitura, cliente',
                  ),
                ),
                TextFormField(
                  controller: responsible,
                  decoration: const InputDecoration(
                    labelText: 'Responsável, cliente ou dispositivo',
                  ),
                ),
                TextFormField(
                  controller: reference,
                  decoration: const InputDecoration(
                    labelText: 'Referência, identificação ou link',
                  ),
                ),
                TextFormField(
                  controller: notes,
