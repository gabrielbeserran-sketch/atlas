...
extension AtlasOperationsEnterpriseModuleX on AtlasOperationsEnterpriseModule {
  String get code => switch (this) {
    ...
    AtlasOperationsEnterpriseModule.workOrders => 'work_orders',
    AtlasOperationsEnterpriseModule.teamManagement => 'team_management',
    AtlasOperationsEnterpriseModule.workdayControl => 'workday_control',
    ...
    AtlasOperationsEnterpriseModule.operationsCenter => 'operations_center',
  };
  ...
  String get title => switch (this) {
    ...
    AtlasOperationsEnterpriseModule.workOrders => 'Ordens de Serviço',
    AtlasOperationsEnterpriseModule.teamManagement => 'Gestão de Equipes',
    AtlasOperationsEnterpriseModule.workdayControl => 'Controle de Jornada',
    AtlasOperationsEnterpriseModule.machineryManagement => 'Gestão de Máquinas',
    AtlasOperationsEnterpriseModule.preventiveMaintenance =>
...
class AtlasOperationsEnterpriseRecord {
  ...
  factory AtlasOperationsEnterpriseRecord.fromMap(Map<String, dynamic> map) {
    final code = map['module']?.toString() ?? '';
    final module = AtlasOperationsEnterpriseModule.values.firstWhere(
      (item) => item.code == code,
      orElse: () => AtlasOperationsEnterpriseModule.farmOperationalPlanning,
    );
    ...
    return AtlasOperationsEnterpriseRecord(
      ...
      plannedHours: (map['plannedHours'] as num?)?.toDouble() ?? 0,
      actualHours: (map['actualHours'] as num?)?.toDouble() ?? 0,
      plannedCost: (map['plannedCost'] as num?)?.toDouble() ?? 0,
