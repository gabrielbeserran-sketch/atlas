...
class AtlasExecutiveKpiLoaderService {
  ...
  final AtlasExecutiveAlertLoaderService
      farmDataLoader;

  Future<AtlasExecutiveKpiLoadResult>
      load() async {
    final loaded =
        await farmDataLoader.load();
    ...
    final farms = loaded.inputs.map((input) {
      ...
      final actionProgress =
          _actionProgress(trackedActions);
      ...
      return AtlasExecutiveFarmKpiInput(
        ...
        kpis: [
          AtlasExecutiveKpiInput(
            ...
            description:
                'Desempenho consolidado da propriedade.',
            category:
          ...
          AtlasExecutiveKpiInput(
            ...
            description:
                'Pontuação calculada pelo Diagnóstico Inteligente.',
            category:
                AtlasExecutiveKpiCategory
                    .intelligence,
          ...
          AtlasExecutiveKpiInput(
            ...
            description:
                intelligence.finance.analysis,
            category:
                AtlasExecutiveKpiCategory
                    .finance,
            value:
                intelligence.finance.score,
            unit: 'pontos',
            targetValue: 85,
            direction:
                AtlasExecutiveKpiDirection
          ...
          AtlasExecutiveKpiInput(
            ...
            title:
                'Margem financeira',
            description:
                'Percentual das receitas preservado após as despesas.',
            category:
                AtlasExecutiveKpiCategory
                    .finance,
            value:
                intelligence.finance.margin,
            unit: '%',
            targetValue: 20,
            direction:
                AtlasExecutiveKpiDirection
          ...
          AtlasExecutiveKpiInput(
            ...
            description:
                intelligence.herd.analysis,
            category:
                AtlasExecutiveKpiCategory
                    .production,
            value:
                intelligence.herd.score,
            unit: 'pontos',
            targetValue: 85,
            direction:
                AtlasExecutiveKpiDirection
          ...
          AtlasExecutiveKpiInput(
            ...
            description:
                'Peso médio dos animais cadastrados na propriedade.',
            category:
                AtlasExecutiveKpiCategory
                    .production,
            value: intelligence
          ...
          AtlasExecutiveKpiInput(
            id: 'paddock_score',
            title:
                'Desempenho dos piquetes',
            description:
                intelligence.paddocks.analysis,
            category:
                AtlasExecutiveKpiCategory
                    .production,
            value: intelligence
          ...
          AtlasExecutiveKpiInput(
            ...
            title:
                'Controle do estoque',
            description:
                intelligence.inventory.analysis,
            category:
                AtlasExecutiveKpiCategory
                    .health,
            value: intelligence
          ...
          AtlasExecutiveKpiInput(
            ...
            title:
                'Execução da agenda',
            description:
                'Percentual de tarefas concluídas na propriedade.',
            category:
                AtlasExecutiveKpiCategory
                    .management,
            value: intelligence
                .agenda.completionRate,
            unit: '%',
            targetValue: 90,
            direction:
                AtlasExecutiveKpiDirection
          ...
          AtlasExecutiveKpiInput(
            ...
            title:
                'Execução das ações da consultoria',
            description:
            ...
            category:
                AtlasExecutiveKpiCategory
                    .management,
            value:
                actionProgress.completionPercent,
            unit: '%',
            targetValue: 90,
            direction:
                AtlasExecutiveKpiDirection
          ...
          AtlasExecutiveKpiInput(
            ...
            title:
                'Ações atrasadas da consultoria',
            description:
            ...
            category:
                AtlasExecutiveKpiCategory
                    .management,
            value:
                actionProgress.overdue.toDouble(),
            unit: 'ações',
            targetValue: 1,
            direction:
                AtlasExecutiveKpiDirection
    ...
    return AtlasExecutiveKpiLoadResult(
      farms: farms,
    );
  }

  _KpiActionProgress _actionProgress(
...
class AtlasExecutiveKpiLoadResult {
  const AtlasExecutiveKpiLoadResult({
    required this.farms,
  });

  final List<AtlasExecutiveFarmKpiInput>
      farms;
}
