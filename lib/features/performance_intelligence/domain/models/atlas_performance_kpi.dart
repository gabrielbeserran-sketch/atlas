...
class AtlasPerformanceKpi {
  ...
  double get variation => previousValue == 0
      ? 0
  ...
  AtlasPerformanceKpi copyWith({
    ...
    maximumTarget: maximumTarget ?? this.maximumTarget,
  ...
  factory AtlasPerformanceKpi.fromJson(Map<String, dynamic> json) =>
      AtlasPerformanceKpi(
        id: json['id'] as String,
        farmId: (json['farmId'] as String?) ?? '',
        name: json['name'] as String,
        category: AtlasKpiCategory.values.byName(
          (json['category'] as String?) ?? 'productive',
        ),
        ...
        direction: AtlasKpiDirection.values.byName(
          (json['direction'] as String?) ?? 'higherIsBetter',
        ),
        updatedAt:
