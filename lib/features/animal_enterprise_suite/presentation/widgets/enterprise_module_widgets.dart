...
class EnterpriseMetricCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = warning ? Colors.orange.shade800 : const Color(0xFF1B5E20);
    return SizedBox(
      width: 340,
      child: Card(
        child: Padding(
...
class EnterpriseSectionTitle extends StatelessWidget {
  const EnterpriseSectionTitle(this.title, this.subtitle, {super.key});
...
String enterpriseDate(DateTime d) {
  final day = d.day.toString().padLeft(2, '0');
  final month = d.month.toString().padLeft(2, '0');
  return '$day/$month/${d.year}';
}

DateTime parseEnterpriseDate(String value) {
