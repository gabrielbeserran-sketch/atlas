...
class AtlasReproductivePremiumStorageService {
  ...
  String _key({required String farmName, required String animalId}) {
    return 'atlas_reproductive_premium_'
        '${_normalize(farmName)}_'
        '${_normalize(animalId)}';
  }

  Future<List<AtlasReproductivePremiumRecord>> load({
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (item) => AtlasReproductivePremiumRecord.fromMap(
