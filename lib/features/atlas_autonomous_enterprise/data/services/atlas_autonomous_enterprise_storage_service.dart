...
class AtlasAutonomousEnterpriseStorageService {
  ...
  String _key({required String farmName, required String animalId}) {
    return 'atlas_autonomous_enterprise_'
        '${_normalize(farmName)}_'
        '${_normalize(animalId)}';
  }

  Future<List<AtlasAutonomousEnterpriseRecord>> load({
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (item) => AtlasAutonomousEnterpriseRecord.fromMap(
