class AtlasBusinessDashboardData {
  const AtlasBusinessDashboardData({
  ...
  factory AtlasBusinessDashboardData.fromJson(Map<String, dynamic> json) =>
      AtlasBusinessDashboardData(
        commercial: Map<String, dynamic>.from(
          json['commercial'] as Map? ?? const {},
        ),
        consulting: Map<String, dynamic>.from(
          json['consulting'] as Map? ?? const {},
        ),
        enterprise: Map<String, dynamic>.from(
          json['enterprise'] as Map? ?? const {},
        ),
