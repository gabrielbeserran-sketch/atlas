...
class AtlasExecutionTask {
  ...
  factory AtlasExecutionTask.fromJson(Map<String, dynamic> json) =>
      AtlasExecutionTask(
        ...
        priority: AtlasExecutionPriority.values.byName(
          (json['priority'] as String?) ?? 'medium',
        ),
        status: AtlasExecutionTaskStatus.values.byName(
          (json['status'] as String?) ?? 'planned',
        ),
        dependencyIds: List<String>.from(
          (json['dependencyIds'] as List?) ?? const [],
        ),
        resourceNames: List<String>.from(
          (json['resourceNames'] as List?) ?? const [],
        ),
      );
}

class AtlasExecutionPlan {
  const AtlasExecutionPlan({
    required this.id,
  ...
  AtlasExecutionPlan copyWith({
    String? id,
    String? farmId,
    String? title,
    String? objective,
    DateTime? createdAt,
    List<AtlasExecutionTask>? tasks,
  }) => AtlasExecutionPlan(
    id: id ?? this.id,
  ...
  factory AtlasExecutionPlan.fromJson(Map<String, dynamic> json) =>
      AtlasExecutionPlan(
        id: json['id'] as String,
