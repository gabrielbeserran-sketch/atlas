...
import 'package:projeto_atlas/features/atlas_commercial_operations/data/services/atlas_commercial_operation_storage_service.dart';
...
class AtlasCommercialOperationsScreen extends StatefulWidget {
  const AtlasCommercialOperationsScreen({
  ...
  final AtlasCommercialOperationModule initialModule;

  @override
  State<AtlasCommercialOperationsScreen> createState() =>
      _AtlasCommercialOperationsScreenState();
}

class _AtlasCommercialOperationsScreenState
  ...
  List<AtlasCommercialOperationRecord> records = [];
  bool loading = true;
                ...
                : ListView(
                    ...
                    children: [
                      ...
                      const EnterpriseSectionTitle(
                        'Registros comerciais e operacionais',
...
class _RecordCard extends StatelessWidget {
  ...
  final AtlasCommercialOperationRecord record;
...
class _CommercialOperationForm extends StatefulWidget {
  ...
  @override
  State<_CommercialOperationForm> createState() =>
...
class _CommercialOperationFormState extends State<_CommercialOperationForm> {
  ...
  late final TextEditingController distanceKm;
  ...
  void initState() {
    ...
    distanceKm = TextEditingController(
      text: current == null || current.distanceKm == 0
          ? ''
