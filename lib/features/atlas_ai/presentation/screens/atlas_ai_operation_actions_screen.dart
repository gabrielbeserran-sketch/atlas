...
class AtlasAiOperationActionsScreen extends StatefulWidget {
  ...
  @override
  State<AtlasAiOperationActionsScreen> createState() {
...
class _AtlasAiOperationActionsScreenState
  ...
  AtlasAiOperationActions get data => widget.data;

  List<AtlasAiOperationPriorityAction> get filteredActions {
    return data.priorityActions.where((item) {
      final action = item.action;

      if (selectedStatus != null && action.status != selectedStatus) {
        return false;
      }

      if (selectedFarm != null && action.farmName != selectedFarm) {
        return false;
      }
          ...
          child: ConstrainedBox(
            ...
            child: data.hasActions
                ? ListView(
                    ...
                    children: [
                      _OperationActionsHero(data: data),
                      ...
                      const SizedBox(height: 13),
                      _AreaSummaryGrid(areas: data.areaSummaries),
...
class _OperationActionsHero extends StatelessWidget {
  const _OperationActionsHero({required this.data});
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final information = Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 9,
                children: [
                  _HeroChip(label: 'Total', value: progress.total),
                  _HeroChip(label: 'Pendentes', value: progress.pending),
                  _HeroChip(label: 'Em andamento', value: progress.inProgress),
                  _HeroChip(label: 'Atrasadas', value: progress.overdue),
                ],
              ),
            ],
          );
          ...
          if (compact) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [information, const SizedBox(height: 20), percentage],
            );
          }
...
class _FiltersBar extends StatelessWidget {
  ...
  final ValueChanged<AtlasAiTrackedActionStatus?> onStatusChanged;
      ...
      child: Padding(
        ...
        child: Wrap(
          ...
          children: [
            ...
            SizedBox(
              width: 250,
              child: DropdownButtonFormField<AtlasAiTrackedActionStatus?>(
...
class _FarmProgressGrid extends StatelessWidget {
  const _FarmProgressGrid({required this.farms, required this.onOpenFarm});
      ...
      builder: (context, constraints) {
        ...
        return Wrap(
          ...
          children: farms.map((farm) {
            final color = farm.overdue > 0
                ? const Color(0xFFC62828)
                : farm.completionPercent >= 80
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            minHeight: 8,
                            value: farm.completionPercent / 100,
...
class _PriorityActionList extends StatelessWidget {
  ...
  final List<AtlasAiOperationPriorityAction> actions;
    ...
    return Column(
      children: actions.map((item) {
        ...
        final color = action.isOverdue
            ? const Color(0xFFC62828)
            : action.status == AtlasAiTrackedActionStatus.inProgress
            ? const Color(0xFF1565C0)
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            ActionChip(
                              ...
                              label: Text(atlasFarmAreaLabel(action.area)),
                              onPressed: onOpenArea == null
                                  ? null
                                  : () {
                                      onOpenArea!(action.farmName, action.area);
                                    },
                            ),
                          ],
                        ),
...
class _AreaSummaryGrid extends StatelessWidget {
  const _AreaSummaryGrid({required this.areas});
