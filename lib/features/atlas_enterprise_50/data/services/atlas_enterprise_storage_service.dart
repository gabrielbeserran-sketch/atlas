...
class AtlasEnterpriseStorageService {
  ...
  String _key({
    ...
    return 'atlas_enterprise_50_${_normalize(farmName)}_${_normalize(animalId)}';
  }

  Future<List<AtlasEnterpriseRecord>> load({
    required String farmName,
    required String animalId,
  }) async {
    ...
    try {
      ...
      return list
          .map(
            (item) => AtlasEnterpriseRecord.fromMap(
