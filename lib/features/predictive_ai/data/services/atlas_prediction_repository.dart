...
class AtlasPredictionRepository {
  ...
  static final AtlasPredictionRepository instance =
      AtlasPredictionRepository._();
  ...
  Future<List<AtlasPredictiveScenario>> loadAll() async {
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (e) => AtlasPredictiveScenario.fromJson(
  ...
  List<AtlasPredictiveScenario> _seeds() => <AtlasPredictiveScenario>[
    AtlasPredictiveScenario(
      id: 'pred_${DateTime.now().millisecondsSinceEpoch}_1',
      farmId: '',
      title: 'Reforma de 30 hectares de pastagem',
      description:
          'Avalia impacto da reforma sobre lotação, produtividade e resultado financeiro.',
      area: AtlasPredictionArea.production,
      createdAt: DateTime.now(),
      investment: 180000,
      currentRevenue: 145000,
      currentCost: 98000,
      productivityChange: 14,
      costChange: 6,
      revenueChange: 9,
      capacityChange: 12,
      horizonMonths: 24,
    ...
    AtlasPredictiveScenario(
      id: 'pred_${DateTime.now().millisecondsSinceEpoch}_2',
      farmId: '',
      title: 'Antecipação do protocolo de IATF',
      description:
          'Projeta efeito reprodutivo e financeiro da antecipação do protocolo.',
      area: AtlasPredictionArea.reproduction,
      createdAt: DateTime.now(),
      investment: 52000,
      currentRevenue: 145000,
      currentCost: 98000,
