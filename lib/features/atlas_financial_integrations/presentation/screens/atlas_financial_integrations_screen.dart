...
import 'package:projeto_atlas/features/atlas_financial_integrations/data/services/atlas_financial_integration_storage_service.dart';
...
class AtlasFinancialIntegrationsScreen extends StatefulWidget {
  const AtlasFinancialIntegrationsScreen({
  ...
  final AtlasFinancialIntegrationModule initialModule;

  @override
  State<AtlasFinancialIntegrationsScreen> createState() =>
      _AtlasFinancialIntegrationsScreenState();
}

class _AtlasFinancialIntegrationsScreenState
  ...
  List<AtlasFinancialIntegrationRecord> records = [];
  bool loading = true;
  ...
  Future<void> load() async {
    ...
    loaded.sort(
      (first, second) => parseAtlasFinancialDate(
        second.date,
      ).compareTo(parseAtlasFinancialDate(first.date)),
    );
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: const ListTile(
                          ...
                          title: Text(
                            'Central financeira e fiscal preparatória',
                          ),
                          subtitle: Text(
                            'A entrega organiza registros, conciliação, documentos e auditoria. '
                            'Operações reais exigem APIs homologadas, credenciais, autorização e validação humana.',
                          ),
                        ),
                      ),
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          EnterpriseMetricCard(
                            ...
                            subtitle: 'Preparação e processamento',
...
class _RecordCard extends StatelessWidget {
  ...
  final AtlasFinancialIntegrationRecord record;
    ...
    return Card(
      child: ListTile(
        ...
        subtitle: Text(
          ...
          '${record.documentNumber.isEmpty ? '' : ' • ${record.documentNumber}'}',
        ),
        isThreeLine: true,
...
class _FinancialIntegrationForm extends StatefulWidget {
  ...
  @override
  State<_FinancialIntegrationForm> createState() =>
...
class _FinancialIntegrationFormState extends State<_FinancialIntegrationForm> {
  ...
  late final TextEditingController documentNumber;
  ...
  void initState() {
    ...
    feeAmount = TextEditingController(
      text: current == null || current.feeAmount == 0
          ? ''
          : current.feeAmount.toString(),
    );
  ...
  Future<void> chooseDate(TextEditingController controller) async {
    ...
    setState(() {
      controller.text = formatAtlasFinancialDate(selected);
    });
  }
