                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _MetricCard(
                          ...
                          value:
                              '${dashboard['active_connections'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Conexões degradadas',
                          value:
                              '${dashboard['degraded_connections'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Jobs pendentes',
                          value:
                              '${dashboard['queued_jobs'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Webhooks pendentes',
                          value:
                              '${dashboard['pending_webhooks'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Aplicações parceiras',
                          value:
                              '${dashboard['active_partner_applications'] ?? 0}',
                        ),
                      ],
                    ),
