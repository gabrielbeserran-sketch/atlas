              ...
              : ListView(
                  ...
                  children: [
                    Wrap(
                      ...
                      children: [
                        _MetricCard(
                          ...
                          value:
                              '${dashboard['posture_score'] ?? 0}%',
                        ),
                        _MetricCard(
                          title: 'Políticas ativas',
                          value:
                              '${dashboard['active_policies'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Riscos abertos',
                          value:
                              '${dashboard['open_risks'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Revisões atrasadas',
                          value:
                              '${dashboard['overdue_reviews'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Solicitações de privacidade',
                          value:
                              '${dashboard['open_privacy_requests'] ?? 0}',
                        ),
                        _MetricCard(
                          title: 'Planos sem teste',
                          value:
                              '${dashboard['untested_continuity_plans'] ?? 0}',
                        ),
                      ],
                    ),
                    ...
                    if (risks.isEmpty)
                      const Card(
                        child: ListTile(
                          title: Text('Nenhum risco cadastrado.'),
                        ),
                      )
                    else
                      ...risks.take(8).map(
