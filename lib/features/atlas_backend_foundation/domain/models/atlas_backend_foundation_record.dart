...
extension AtlasBackendFoundationModuleX on AtlasBackendFoundationModule {
  String get code => switch (this) {
    ...
    AtlasBackendFoundationModule.backendAdministrationCenter =>
      'backend_administration_center',
  };

  String get title => switch (this) {
    AtlasBackendFoundationModule.backendFoundation =>
      'Fundação do Backend Atlas',
    AtlasBackendFoundationModule.environmentConfiguration =>
      'Configuração de Ambientes',
    AtlasBackendFoundationModule.postgresqlDatabase =>
      'Banco de Dados PostgreSQL',
    AtlasBackendFoundationModule.versionedMigrations => 'Migrações Versionadas',
    AtlasBackendFoundationModule.multiCompanyArchitecture =>
      'Arquitetura Multempresa',
    AtlasBackendFoundationModule.usersCompaniesApi =>
      'API de Usuários e Empresas',
    ...
    AtlasBackendFoundationModule.livestockEventsApi =>
      'API de Eventos Pecuários',
    AtlasBackendFoundationModule.backendAdministrationCenter =>
...
class AtlasBackendFoundationRecord {
  ...
  bool get isOperational =>
      const ['Ativo', 'Validado', 'Concluído', 'Disponível'].contains(status);
