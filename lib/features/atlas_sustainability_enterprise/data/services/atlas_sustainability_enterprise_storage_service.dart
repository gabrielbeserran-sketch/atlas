...
class AtlasSustainabilityEnterpriseStorageService {
  ...
  String _key({required String farmName, required String animalId}) {
    return 'atlas_sustainability_enterprise_'
        '${_normalize(farmName)}_'
        '${_normalize(animalId)}';
  }

  Future<List<AtlasSustainabilityEnterpriseRecord>> load({
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (item) => AtlasSustainabilityEnterpriseRecord.fromMap(
