...
class AtlasCommercialEnterpriseStorageService {
  ...
  String _key({required String farmName, required String animalId}) {
    return 'atlas_commercial_enterprise_'
        '${_normalize(farmName)}_'
        '${_normalize(animalId)}';
  }

  Future<List<AtlasCommercialEnterpriseRecord>> load({
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (item) => AtlasCommercialEnterpriseRecord.fromMap(
