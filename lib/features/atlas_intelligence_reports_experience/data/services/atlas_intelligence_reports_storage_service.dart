...
class AtlasIntelligenceReportsStorageService {
  ...
  String _key({required String farmName, required String animalId}) {
    return 'atlas_intelligence_reports_'
        '${_normalize(farmName)}_'
        '${_normalize(animalId)}';
  }

  Future<List<AtlasIntelligenceReportsRecord>> load({
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (item) => AtlasIntelligenceReportsRecord.fromMap(
