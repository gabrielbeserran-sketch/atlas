...
import 'package:projeto_atlas/features/atlas_platform_resilience/data/services/atlas_platform_resilience_storage_service.dart';
...
class AtlasPlatformResilienceScreen extends StatefulWidget {
  const AtlasPlatformResilienceScreen({
  ...
  final AtlasPlatformResilienceModule initialModule;

  @override
  State<AtlasPlatformResilienceScreen> createState() =>
      _AtlasPlatformResilienceScreenState();
}

class _AtlasPlatformResilienceScreenState
    extends State<AtlasPlatformResilienceScreen> {
  final AtlasPlatformResilienceStorageService storage =
      AtlasPlatformResilienceStorageService();
  final AtlasPlatformResilienceAnalyticsService analyticsService =
      const AtlasPlatformResilienceAnalyticsService();

  late AtlasPlatformResilienceModule selectedModule;
  List<AtlasPlatformResilienceRecord> records = [];
  bool loading = true;
  ...
  Future<void> load() async {
    ...
    loaded.sort(
      (first, second) => parseAtlasPlatformDate(
        second.date,
      ).compareTo(parseAtlasPlatformDate(first.date)),
    );
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          EnterpriseMetricCard(
                            ...
                            subtitle: 'Ativos ou disponíveis',
                          ...
                          EnterpriseMetricCard(
                            ...
                            subtitle: 'Evolução da implantação',
...
class _RecordCard extends StatelessWidget {
  ...
  final AtlasPlatformResilienceRecord record;
    ...
    return Card(
      child: ListTile(
        ...
        subtitle: Text(
          ...
          '${record.owner.isEmpty ? '' : ' • ${record.owner}'}',
        ),
        isThreeLine: true,
...
class _PlatformResilienceForm extends StatefulWidget {
  ...
  @override
  State<_PlatformResilienceForm> createState() =>
...
class _PlatformResilienceFormState extends State<_PlatformResilienceForm> {
  ...
  Future<void> chooseDate(TextEditingController controller) async {
    ...
    setState(() {
      controller.text = formatAtlasPlatformDate(selected);
    });
  }
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  controller: owner,
                  decoration: const InputDecoration(
                    labelText: 'Responsável ou proprietário',
                  ),
                ),
                TextFormField(
