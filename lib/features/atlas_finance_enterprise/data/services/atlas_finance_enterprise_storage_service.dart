...
class AtlasFinanceEnterpriseStorageService {
  ...
  String _key({required String farmName, required String animalId}) {
    return 'atlas_finance_enterprise_'
        '${_normalize(farmName)}_'
        '${_normalize(animalId)}';
  }

  Future<List<AtlasFinanceEnterpriseRecord>> load({
    ...
    try {
      return (jsonDecode(raw) as List<dynamic>)
          .map(
            (item) => AtlasFinanceEnterpriseRecord.fromMap(
