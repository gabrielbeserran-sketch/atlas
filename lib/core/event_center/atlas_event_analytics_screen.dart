...
class AtlasEventAnalyticsScreen
    extends StatefulWidget {
  const AtlasEventAnalyticsScreen({
    super.key,
  });

  @override
  State<AtlasEventAnalyticsScreen>
      createState() {
    return _AtlasEventAnalyticsScreenState();
  }
}

class _AtlasEventAnalyticsScreenState
    extends State<AtlasEventAnalyticsScreen> {
  final AtlasEventAnalyticsService service =
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          const _SectionTitle(
                            ...
                            subtitle:
                                'Evolução diária dos eventos registrados.',
                          ),
                          const SizedBox(
                            height: 12,
                          ),
                          ...
                          const _SectionTitle(
                            title:
                                'Módulos mais ativos',
                            subtitle:
                                'Distribuição das ocorrências por módulo.',
                          ),
                          const SizedBox(
                            height: 12,
                          ),
                          ...
                          const _SectionTitle(
                            title:
                                'Fazendas com mais ocorrências',
                            subtitle:
                                'Ranking por volume de eventos.',
                          ),
                          const SizedBox(
                            height: 12,
                          ),
                          ...
                          const _SectionTitle(
                            ...
                            subtitle:
                                'Eventos que mais se repetem no histórico.',
                          ),
                          const SizedBox(
                            height: 12,
                          ),
...
class _MetricGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      (
        'Últimos 7 dias',
        data.last7DaysEvents,
        Icons.date_range_outlined,
      ),
      (
        'Últimos 30 dias',
        data.last30DaysEvents,
...
class _CriticalPatternList
    extends StatelessWidget {
  const _CriticalPatternList({
    required this.items,
  });

  final List<
          AtlasEventAnalyticsCriticalPattern>
      items;
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty) {
      return const _EmptySection(
        message:
            'Nenhum padrão crítico recorrente identificado.',
      );
    }
